class CameraAgoraCard extends HTMLElement {
  ...
  async _playVideo() {
    ...
    try {
      ...
      await this._hass.callService("mammotion_lite", "refresh_stream", {
        entity_id: entityId,
      });
      await this._hass.callService("mammotion_lite", "start_video", {
        entity_id: entityId,
      });
      ...
      client.on("user-unpublished", (user, mediaType) => {
        if (mediaType === "video") {
          ...
          if (
            this._currentVideoIndex >= this._remoteUsers.length &&
            this._remoteUsers.length > 0
          ) {
  ...
  async _stopVideo() {
    ...
    try {
      ...
      if (this._hass && this._config && this._config.entity) {
        await this._hass.callService("mammotion_lite", "stop_video", {
